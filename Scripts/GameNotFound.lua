...
local Window = Library:CreateWindow("DarkHub".." - Game not Supported")

local LocalPlayer = Window:Page("LocalPlayer")

local Misc = Window:Page("Misc")

local filename = "GrannyHub/GameNotSupported/Config.json"
...
makefolder("GrannyHub/GameNotSupported");
